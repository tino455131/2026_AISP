...
- Success Definition: We will consider the system effective if its suggestions are sufficiently useful to improve collaborative outcomes (e.g., discussion efficiency, output quality, and willingness to communicate) while reducing the cognitive load of both team leaders and team members.
- Target Users: Teams with a hierarchical organizational structure.
- Method: Pre- and post-study surveys, brief interviews, and analysis of AI-agent chat histories.
